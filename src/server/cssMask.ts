/**
 * cssMask.ts — Masked view of CSS source text
 *
 * All line-selection and brace-counting in the commit pipeline runs on a
 * masked copy of the source so comments, string literals and url() bodies
 * can't fool the matchers. Extracted from commit.ts (structural split only).
 */
