...
// existing importers (route dispatch, tests) keep working.
import type { CommitChange, CommitResult } from "../lib/protocol";
export type { CommitChange, CommitResult } from "../lib/protocol";
