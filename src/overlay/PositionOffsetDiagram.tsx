  ...
  return (
    <div style={{ padding: "8px 12px 4px" }}>
      ...
      >
        ...
        >
          <span style={{ fontSize: "8px", textTransform: "uppercase", letterSpacing: "0.05em", color: "rgba(0,0,0,0.35)" }}>
            Offset
          </span>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          >
            <span style={{ fontSize: "8px", color: "rgba(0,0,0,0.25)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
              element
            </span>
          </div>
          <div style={{ flex: "0 0 40px", display: "flex", justifyContent: "center" }}>
  ...
  return (
    <span
      ...
      style={{
        fontSize: "10px",
        fontFamily: "ui-monospace, 'SF Mono', monospace",
        color: value !== 0 ? "rgba(0,0,0,0.65)" : "rgba(0,0,0,0.3)",
        cursor: "text",
        padding: "1px 3px",
        borderRadius: "2px",
        minWidth: "16px",
    ...
    >
      {value}
      {suffix && (
        <span style={{ fontSize: "8px", color: "rgba(0,0,0,0.3)", marginLeft: "1px" }}>
          {suffix}
        </span>
      )}
    </span>
