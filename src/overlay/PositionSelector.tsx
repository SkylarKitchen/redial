    ...
    <div style={{ display: "flex", alignItems: "center", gap: "6px", padding: "2px 12px" }}>
      ...
      <div ref={containerRef} style={{ position: "relative", flex: 1 }}>
        ...
        >
          ...
          <ChevronDown size={10} strokeWidth={2} style={{ color: "rgba(0,0,0,0.35)", flexShrink: 0, marginLeft: "4px" }} />
        </button>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "6px 10px",
                      cursor: "pointer",
                      background: isActive ? "rgba(193,122,80,0.12)" : "transparent",
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        width: "20px",
                        height: "20px",
                        color: isActive ? "rgba(0,0,0,0.87)" : "rgba(0,0,0,0.45)",
                        flexShrink: 0,
                      }}
                    >
                      {opt.icon}
                    ...
                    <span
                      style={{
                        fontSize: "12px",
                        color: isActive ? "rgba(0,0,0,0.87)" : "rgba(0,0,0,0.65)",
