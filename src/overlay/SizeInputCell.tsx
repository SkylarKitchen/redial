  ...
  return (
    ...
    <div
      ...
      className={cn(
        ...
        isModified
          ? "bg-[rgba(193,122,80,0.1)] border border-[rgba(193,122,80,0.25)]"
          : "bg-[rgba(0,0,0,0.04)] border border-black/10"
      )}
      ...
      <div className="flex flex-1 items-center justify-end pr-0.5 min-w-0">
        {isKeyword ? (
          <span
            ...
            className="text-[10px] font-mono text-black/60 capitalize pr-1 cursor-text outline-none"
          >
            {keyword}
          </span>
        ) : isVariable ? (
          ...
          <input
            ...
            autoFocus
            className="w-9 bg-black/[0.04] border border-[rgba(193,122,80,0.5)] rounded-sm text-black/87 text-[10px] font-mono text-right px-[3px] py-px outline-none"
          />
        ) : (
          <span
            tabIndex={0}
            ...
            className={cn(
              ...
              value !== 0 ? "text-black/80" : "text-black/30"
            )}
          >
            {value}
          </span>
