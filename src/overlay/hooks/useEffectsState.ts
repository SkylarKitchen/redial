/**
 * useEffectsState.ts — State and handlers for the Effects section
 */
...
export function useEffectsState(cs: Record<string, string>, apply: (prop: string, value: string) => void) {
  ...
  return {
    ...
    handlers: {
      ...
      handleShadowsChange,
      handleTransformsChange,
      handleTransformOriginChange,
      handleFilterChange,
      handleBackdropFilterChange,
      handleTransitionsChange,
      handleCursorChange,
      handlePointerEventsChange,
