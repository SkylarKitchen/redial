    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div style={{ display: "flex", gap: 4, flex: 1 }}>
              {(["r", "g", "b"] as const).map((ch) => (
                <div key={ch} style={{ display: "flex", alignItems: "center", gap: 2, flex: 1 }}>
                  <span style={{ fontSize: 9, color: "rgba(0,0,0,0.35)", fontFamily: "ui-monospace, 'SF Mono', monospace", textTransform: "uppercase" }}>{ch}</span>
                  <input
                    type="text"
                    value={currentRgb[ch]}
            ...
            <div style={{ display: "flex", gap: 4, flex: 1 }}>
              {([
                ...
                <div key={key} style={{ display: "flex", alignItems: "center", gap: 2, flex: 1 }}>
                  <span style={{ fontSize: 9, color: "rgba(0,0,0,0.35)", fontFamily: "ui-monospace, 'SF Mono', monospace", textTransform: "uppercase" }}>{key}</span>
                  <input
                    type="text"
                    value={val}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 3, flexShrink: 0 }}>
            <span style={{ fontSize: 9, color: "rgba(0,0,0,0.35)", fontFamily: "ui-monospace, 'SF Mono', monospace" }}>A</span>
      ...
      {colorVars.length > 0 && (
        <div style={{ borderTop: "1px solid rgba(0,0,0,0.06)", paddingTop: 8 }}>
          <span style={{ fontSize: 9, color: "rgba(0,0,0,0.35)", textTransform: "uppercase", letterSpacing: "0.04em", display: "block", marginBottom: 6 }}>
            Variables
          </span>
            ...
            {colorVars.map((cv) => {
              ...
              return (
                <button
                  ...
                  onMouseLeave={(e) => {
                    if (!isActive) (e.currentTarget as HTMLElement).style.borderColor = "rgba(0,0,0,0.1)";
      ...
      <div style={{ borderTop: "1px solid rgba(0,0,0,0.06)", paddingTop: 8 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
          <span style={{ fontSize: 9, color: "rgba(0,0,0,0.35)", textTransform: "uppercase", letterSpacing: "0.04em" }}>
            Swatches
          </span>
      ...
      {recentColors.length > 0 && (
        <div style={{ borderTop: "1px solid rgba(0,0,0,0.06)", paddingTop: 6 }}>
          <span style={{ fontSize: 9, color: "rgba(0,0,0,0.25)", textTransform: "uppercase", letterSpacing: "0.04em" }}>
            Recent
          </span>
