          ...
          return (
            <button
              ...
              style={{
                ...
                borderLeft: isFirst ? "1px solid rgba(0,0,0,0.08)" : "none",
          ...
          return (
            <div
              ...
              style={{
                ...
                borderBottom: `8px solid ${isSelected ? "#c17a50" : "rgba(0,0,0,0.4)"}`,
                cursor: "pointer",
              }}
            />
          );
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: "3px",
              color: stops.length <= 2 ? "rgba(0,0,0,0.15)" : "rgba(0,0,0,0.35)",
              fontSize: "14px",
