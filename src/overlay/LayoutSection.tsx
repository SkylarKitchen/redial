...
export const LayoutSection = memo(function LayoutSection(props: LayoutSectionProps) {
  ...
  return (
    ...
    >
          ...
          <div className="flex items-start gap-2 py-1 px-3">
            ...
            <div className="flex-1 flex flex-col gap-1 pt-0.5">
              <div className="flex items-center gap-1">
                <span className="text-[10px] text-[rgba(0,0,0,0.35)] w-3 text-right">x</span>
                <MiniDropdown
              ...
              <div className="flex items-center gap-1">
                <span className="text-[10px] text-[rgba(0,0,0,0.35)] w-3 text-right">y</span>
                <MiniDropdown
            ...
            <div className="flex items-center gap-1.5 py-0.5 px-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  showGridOverlay
                    ? "bg-[rgba(193,122,80,0.15)] border border-[rgba(193,122,80,0.4)] text-[rgba(193,122,80,0.9)]"
          ...
          {gapLocked ? (
            <div className="flex items-center">
              ...
              <button
                ...
                className="w-5 h-5 flex items-center justify-center bg-transparent border-none cursor-pointer text-[rgba(0,0,0,0.4)] text-[10px] mr-2 rounded-[3px] shrink-0"
              >
            ...
            <>
              <div className="flex items-center">
                ...
                <button
                  onClick={handleGapLockToggle}
                  title="Lock gap"
                  className="w-5 h-5 flex items-center justify-center bg-transparent border-none cursor-pointer text-[rgba(0,0,0,0.25)] text-[10px] mr-2 rounded-[3px] shrink-0"
                >
                  <Link size={12} strokeWidth={1.5} />
                </button>
              </div>
      ...
      {parentIsFlexOrGrid && (
        <>
          <div className="pt-1.5 pb-0.5 px-3 text-[10px] text-[rgba(0,0,0,0.35)] uppercase tracking-[0.04em]">
