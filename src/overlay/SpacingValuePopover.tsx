        ...
        >
          <input
            ...
            style={{
              ...
              background: `linear-gradient(to right, #c17a50 ${sliderPct}%, rgba(0,0,0,0.12) ${sliderPct}%)`,
              borderRadius: "2px",
              outline: "none",
              cursor: "pointer",
            }}
              ...
              {units.map((u) => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: "10px",
                    fontFamily: "ui-monospace, 'SF Mono', monospace",
                    color: u === unit ? "#fff" : "rgba(0,0,0,0.5)",
        ...
        {PRESETS.map((preset) => (
          <button
            ...
            style={{
              height: "28px",
              background:
                value === preset ? "rgba(193,122,80,0.2)" : "rgba(0,0,0,0.04)",
              border:
                value === preset
                  ? "1px solid rgba(193,122,80,0.4)"
                  : "1px solid rgba(0,0,0,0.07)",
              borderRadius: "4px",
              color: value === preset ? "#fff" : "rgba(0,0,0,0.5)",
              fontSize: "11px",
              fontFamily: "ui-monospace, 'SF Mono', monospace",
              cursor: "pointer",
              outline: "none",
