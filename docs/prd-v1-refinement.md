...
## Section 2 — Selector & Class Manager
...
## Section 12 — Input Controls & Units
...
## Section 13 — Keyboard & Interaction
...
1. **P0 items first** (3 tasks) — quick wins that close real gaps
